...
(function(){function grids(){if(document.getElementById('da-five-column-grids'))return;var st=document.createElement('style');st.id='da-five-column-grids';st.textContent='@media(min-width:1200px){.grid,.cards,.card-grid,.products-grid,.gallery,.shop-grid{grid-template-columns:repeat(5,minmax(0,1fr))!important}}@media(min-width:760px) and (max-width:1199px){.grid,.cards,.card-grid,.products-grid,.gallery,.shop-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important}}@media(max-width:759px){.grid,.cards,.card-grid,.products-grid,.gallery,.shop-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}';document.head.appendChild(st)}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',grids);else grids()})();
