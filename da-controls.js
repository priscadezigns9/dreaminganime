...
(function () {
  ...
  function addBrandLogo() { var host=document.querySelector('.nav, nav, .navbar, header'); if(!host || host.querySelector('.da-brand-logo')) return; var img=document.createElement('img'); img.className='da-brand-logo'; img.src='/logos/dreaming-anime-circle.png'; img.alt='Dreaming Anime'; var first=host.querySelector('a, .logo'); if(first){ first.parentNode.insertBefore(img,first); } else { host.insertBefore(img,host.firstChild); } }
  function init() {
    addBrandLogo();
