...
(function () {
  ...
  function ensurePanel() {
    ...
    var panel = document.createElement('aside'); panel.id = 'da-ada-panel'; panel.setAttribute('aria-live', 'polite'); panel.innerHTML = '<button class="close" id="da-ada-close">CLOSE</button><h2>BUY WITH ADA</h2><p id="da-ada-status">Cardano Preprod checkout. The exact amount is 8 ADA.</p><p class="muted" id="da-ada-network"></p><button id="da-ada-connect">CONNECT WALLET</button><button id="da-ada-pay" disabled>APPROVE 8 ADA PAYMENT</button>'; document.body.appendChild(panel);
